...
hi Statement guifg=White ctermfg=none guibg=Black ctermbg=none  gui=bold cterm=bold term=bold
hi PreProc guifg=White ctermfg=none  guibg=Black ctermbg=none  gui=bold cterm=bold term=bold
"hi String guifg=#778899 ctermfg=Gray guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Comment guifg=#737373 ctermfg=cyan guibg=Black ctermbg=none gui=NONE cterm=NONE term=NONE
"hi Constant guifg=LightGray ctermfg=Gray guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Type guifg=White ctermfg=none guibg=Black ctermbg=none gui=bold cterm=bold term=bold
"hi Function guifg=White ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
"hi Identifier guifg=LightGray ctermfg=Gray guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
"hi Special guifg=LightGray ctermfg=255 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi MatchParen guifg=Black ctermfg=red guibg=LightGreen ctermbg=LightGray gui=NONE cterm=NONE term=NONE
