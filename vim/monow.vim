...
hi Normal guifg=LightGray ctermfg=Gray guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
...
hi Statement guifg=White ctermfg=LightGray guibg=Black ctermbg=16 gui=bold cterm=bold term=bold
...
hi Comment guifg=#737373 ctermfg=cyan guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
